...
lv_obj_t *zmk_display_status_screen() {
    ...
    lv_obj_t *mangologo_icon;
    mangologo_icon = lv_img_create(screen);
    lv_img_set_src(mangologo_icon, &mangologo);
    lv_obj_align(mangologo_icon, LV_ALIGN_BOTTOM_MID, 0, -5);
#endif
